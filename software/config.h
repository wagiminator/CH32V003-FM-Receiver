...
// Pin assignments
#define PIN_SDA         PC1           // I2C Serial Data,  connect to OLED/RDA, do not change
#define PIN_SCL         PC2           // I2C Serial Clock, connect to OLED/RDA, do not change
...
#define RDA_HEADER      "FM Radio"    // default station name (exactly 8 characters!)
